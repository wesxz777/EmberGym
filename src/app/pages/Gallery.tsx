...
export function Gallery() {
  ...
  const transformationGallery = [
    ...
    },
    {
      id: 3,
      name: "Shaun Y.",
      before: "public/TransformationImg/Before_baruela.png",
      after: "public/TransformationImg/After_baruela.jpg",
      duration: "4 months",
      weightLost: "25 lbs",
  ...
  const facilityImages = [
    ...
    {
      id: 5,
      url: "public/TrainingImg/CardioTraining.jpg",
      category: "Training",
      title: "Cardio Training",
    },
    {
      id: 6,
      url: "public/TrainingImg/PersonalTraining.jpg",
      category: "Training",
    ...
    {
      id: 8,
      url: "public/FacilityImg/RestroomsAndLockers.jpg",
      category: "Facility",
